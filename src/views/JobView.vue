...
const deleteJob = async () => {
  try {
    ...
    if (confirm) {
      ...
      router.push('/jobs')
      setTimeout(() =>
        toast.success('Job deleted successfully', { duration: 3000 }, 2000)
      )
...
const contactPhone = computed(() => job.value.company?.contactPhone || 'N/A');
</script>
      ...
      <div class="grid grid-cols-1 md:grid-cols-70/30 w-full gap-6">
        ...
        <aside>
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            ...
            <p class="my-2 bg-green-100 p-2 font-bold">{{ contactPhone }}</p>
          </div>
